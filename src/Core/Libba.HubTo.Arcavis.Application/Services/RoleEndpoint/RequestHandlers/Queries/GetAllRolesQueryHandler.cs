...
public class GetAllRoleEndpointsQueryHandler : IQueryHandler<GetAllRoleEndpointsQuery, IEnumerable<RoleEndpointDto>?>
{
    #region Dependencies
    ...
    public async Task<IEnumerable<RoleEndpointDto>?> Handle(GetAllRoleEndpointsQuery request, CancellationToken cancellationToken)
    {
